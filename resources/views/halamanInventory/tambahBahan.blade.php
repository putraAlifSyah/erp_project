...
<form method="post" action="/bahan">
   ...
   <div class="col-md-4 offset-md-4">
        ...
        <input type="hidden" class="form-control" id="kode_order" name="kode_order" value="{{ $kode_order = 'B'.date('h-i-s-') . mt_rand(1000, 9999); }}">

        <div class="form-group">
            <label for="nama_bahan">Nama Barang</label>
